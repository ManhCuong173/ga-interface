...
export const profileService = {
    removeDiscord: async (params: ParamsRemove) => {
        return await axiosClient.put(`${backend}/profile/remove/discord?publickey=${params.publickey}&wallet_address=${params.wallet_address}`);
    },
    removeTwitter: async (params: ParamsRemove) => {
        return await axiosClient.put(`${backend}/profile/remove/twitter?publickey=${params.publickey}&wallet_address=${params.wallet_address}`);
    },
