    ...
    <>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex items-center space-x-4'>
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          ...
                          result='effect1_dropShadow_972_73232'
                        />
                        <feBlend
                          mode='normal'
                          in='SourceGraphic'
                          in2='effect1_dropShadow_972_73232'
                          result='shape'
                        />
                      </filter>
                    </defs>
          ...
          <span className='text-[20px] font-medium leading-[32px] tracking-[-2%] text-[#4E473F]'>
            {MAX_PAGE_SIZE}
          </span>
        </div>

        {<NFTSection listNft={listNft?.data} isLoading={isLoading} isPick={true} />}
      </div>
      ...
      <div className='flex flex-col gap-4 uppercase'>
        <div className='flex items-start gap-[16px] sm:items-center'>
          ...
          />
          <label className='default-checkbox text-base font-light'>
            I have read and agreed to the risk warning
          </label>
        </div>
        <CustomButton
          disabled={
