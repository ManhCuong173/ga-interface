      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3">
          <input
            ...
            className="w-5 accent-[rgba(239,35,44,1)] h-5 border border-stroke checked:text-[#fff]"
            type="checkbox"
          />
          <span className="text-[#4E473F] sm:text-base text-sm leading-5 tracking-[-3%] font-medium">Select all</span>
        </div>
        <div className="flex items-center space-x-1">
          <span className="text-[#2D8B6F] sm:text-base text-sm leading-5 tracking-[-3%] font-medium">
            {inscribeData.pickedNfts.length}
          </span>
