    ...
    >
      <div className='relative my-8 min-h-[500px] w-full lg:w-[733px] bg-white px-10 pb-[82.15px] pt-[75px] text-text-black'>
        <div className='relative z-[1] flex w-full flex-col items-center gap-6 lg:gap-8'>
          ...
          <p className='text-lg font-medium leading-6 tracking-[-0.6px]'>
          ...
          <div className='relative h-[350px] w-[350px] p-4'>
            ...
            <div className='absolute left-[27px] top-[27px] flex items-center gap-2 rounded bg-[rgba(255,244,221,0.50)] px-2 py-1'>
              <div className='flex h-5 w-5 items-center justify-center rounded-full bg-[#FFF4DD]'>
                <Image
                  src={handleReturnIconType(item?.nft_id || '')}
                  alt=''
                  width={20}
                  height={20}
                />
              </div>
              <span className='left-6 text-xs font-light tracking-[-0.48px]'>
          ...
          <button className='relative' onClick={() => handleRouterAsset()}>
            ...
            <div className='absolute left-0 top-0 flex h-full w-full items-center justify-center gap-2'>
              <span className='text-xl font-medium leading-6 tracking-[-0.6px] text-[#FFDFAC]'>
                view my assets
              </span>
              <svg
        ...
        <Image
          ...
          width={456}
          height={182}
          className='absolute bottom-[23.72px] left-[22.47px]'
        />
        <Image
          src={corner}
          alt=''
