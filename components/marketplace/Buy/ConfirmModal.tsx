        ...
        <ModalLayout>
          <>
            <div ref={ref} className='flex flex-col items-center gap-2'>
              <p className='text-[32px] font-semibold leading-[50px] tracking-[-0.96px]'>
                Confirmation
              </p>
              <p className='text-sm font-light leading-5 tracking-[-0.42px]'>
            ...
            <div className='relative h-[350px] w-[350px] p-4'>
              ...
              <div className='absolute left-[27px] top-[27px] flex h-8 min-w-[124px] items-center justify-center gap-2 rounded bg-[rgba(255,244,221,0.50)] px-2 py-1'>
                ...
                <span className='left-6 text-xs font-medium tracking-[-0.48px]'>
            ...
            <div className='flex w-full flex-col space-y-3'>
              <p className='text-left text-[14px] font-medium text-[#383F4A]'>
            ...
            <div className='w-full rounded border border-[#E5E4E3] p-4 text-[#66605B]'>
              <div className='flex h-[60px] items-center justify-between border-b border-[#E5E4E3]'>
              ...
              <div className='border-b border-[#E5E4E3] py-2'>
                ...
                <div className='flex h-9 items-center justify-between'>
                  <span className='text-sm font-light leading-5 tracking-[-0.42px]'>
                    {data?.sats_in_inscription} VB *{' '}
                    <span className='text-[#FF6634]'>{feeRate}</span> SATS/VB
                  </span>
                  <FormatPrice
                    satValue={
                      Number(data?.sats_in_inscription) ? data?.sats_in_inscription * feeRate : ''
                    }
                  />
                </div>
              </div>
                ...
                <div className='flex flex-col items-center gap-1'>
                  <div className='flex items-center gap-2 text-base font-medium leading-6'>
                    ...
                    <span className='text-[#12B76A]'>
                      ~${' '}
                      {Number(data?.total)
                        ? ((data?.total / Math.pow(10, 8)) * Number(btcToUsdRate)).toFixed(4)
                        : ''}
                    </span>
                  </div>
                </div>
