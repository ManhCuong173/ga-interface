  ...
  return (
    <div className="flex flex-col gap-4 items-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="46" viewBox="0 0 23 46" fill="none">
        <path
          d="M2.10204 13.0714L9.58348 20.6711C10.6852 21.7903 12.4923 21.7831 13.585 20.6551L20.9484 13.054C22.0634 11.9029 21.985 10.052 20.7765 8.99938L13.4146 2.58705C12.3681 1.67557 10.8115 1.66938 9.75785 2.5725L2.27502 8.98613C1.04475 10.0406 0.965308 11.9167 2.10204 13.0714Z"
          stroke="#EF232C"
          strokeWidth="2"
        />
        <path
          d="M2.10204 25.0313L9.58348 32.6311C10.6852 33.7503 12.4923 33.743 13.585 32.615L20.9484 25.0139C22.0634 23.8628 21.985 22.012 20.7765 20.9593L13.4146 14.547C12.3681 13.6355 10.8115 13.6293 9.75785 14.5325L2.27502 20.9461C1.04475 22.0006 0.965308 23.8766 2.10204 25.0313Z"
          stroke="#EF232C"
          strokeWidth="2"
        />
        <path
          d="M2.10204 35.8868L9.58348 43.4866C10.6852 44.6058 12.4923 44.5985 13.585 43.4705L20.9484 35.8694C22.0634 34.7183 21.985 32.8674 20.7765 31.8148L13.4146 25.4025C12.3681 24.491 10.8115 24.4848 9.75785 25.3879L2.27502 31.8016C1.04475 32.856 0.965308 34.7321 2.10204 35.8868Z"
          stroke="#EF232C"
          strokeWidth="2"
        />
      </svg>
      <svg xmlns="http://www.w3.org/2000/svg" width="13" height="134" viewBox="0 0 13 134" fill="none">
        <path d="M6.5 0.527344L6.50001 127.527" stroke="#EF232C" strokeWidth="2" />
