...
import { DEFAULT_WALLET_KEY, WalletItemCardProps } from './types'

const WalletItemCard: React.FC<PropsWithClassName & WalletItemCardProps> = ({ className, logo, name, isDefault }) => {
  const isStorageDefault = isDefault || localStorage?.getItem(DEFAULT_WALLET_KEY)
