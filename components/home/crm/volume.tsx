...
export default function Volume({ data }: Props) {
  ...
  useEffect(() => {
    if (data.length)
      switch (activeTab) {
        case 'week': {
          setChartData(filterVolumeChartDataByWeek(data))
          break
        }
        case 'month': {
          setChartData(filterVolumnChartDataByMonth(data))
          break
        }
        case 'year': {
          setChartData(filterVolumnChartDataByYear(data))
          break
        }
        case 'all': {
          const response = filterVolumnChartDataAuto(data)
