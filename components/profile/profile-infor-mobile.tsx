...
const ProfileInfoMobile = ({ profile, refetch }: PropsProfile) => {
  ...
  return (
    <div className="flex w-full flex-col justify-center gap-4 pt-20 md:hidden">
      <div className="flex">
        <div className="w-[100px]">
          ...
          <button onClick={editProfileClicked} className="mx-auto flex h-10 w-fit items-center mt-[19p]">
        ...
        <div className="flex flex-col ml-4">
          <h2 className='h2 className="w-[250px] truncate text-center text-lg font-medium leading-8 tracking-[-2%] text-black font-Roboto'>
