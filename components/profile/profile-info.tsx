...
export default function ProfileInfo({ profile, refetch }: Props) {
  ...
  return (
    <div className="relative hidden h-fit w-[303.305693px]  flex-col items-center gap-16 px-[40px] py-6 lg:flex">
      <div className="flex w-[250px] flex-col gap-[14px] overflow-hidden">
        ...
        >
          ...
          <span className="text-sm font-light leading-5 tracking-[-3%] text-black1">Edit Profile</span>
        </button>
      </div>
